            ...
            <article className="banner">
                <section className="banner_inner">
                    <div className="banner_text">
                        ...
                        <button type="button" onClick={() => navigate('/market')}>구경하러 가기</button> {/* 버튼 클릭 시 /items로 이동 */}
                    </div>
                ...
                <div className="first">
                    <section>
                        ...
                        <div className="first_text">
                            ...
                            <p className="p_highlight">인기 상품을 <br />확인해 보세요</p>
                            <p className="p_explain">가장 HOT한 중고거래 물품을 <br /> 판다 마켓에서 확인해 보세요</p>
                        </div>
                    </section>
                </div>
                ...
                <div className="second">
                    <section>
                        <div className="second_text">
                            ...
                            <p className="p_highlight">구매를 원하는 <br />상품을 검색하세요</p>
                            <p className="p_explain">구매하고 싶은 물품은 검색해서 <br /> 쉽게 찾아보세요</p>
                        </div>
                ...
                <div className="third">
                    <section>
                        ...
                        <div className="third_text">
                            ...
                            <p className="p_highlight">판매를 원하는 <br /> 상품을 등록하세요</p>
                            <p className="p_explain">어떤 물건이든 판매하고 싶은 상품을 <br /> 쉽게 등록하세요</p>
                        </div>
                    </section>
                </div>
            </article>
